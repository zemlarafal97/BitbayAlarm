...
*/
    ...
    public static void makeBitbayTickerRequest(RequestQueue requestQueue, Alarm alarm, final ServerCallback callback) {


        String query = "https://bitbay.net/API/Public/" + alarm.getCryptoCurrency() + alarm.getCurrency() + "/ticker.json";
